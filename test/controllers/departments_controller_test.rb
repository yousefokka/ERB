...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { location: @department.location, name: @department.name, special: @department.special } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { location: @department.location, name: @department.name, special: @department.special } }
